...
>
> Última actualización: **2026-07-08** · Versión del juego: **0.3.0** · Fase: **4**
...
| ADR-025 | **Build incrementa el patch** de versión: compilar vía `tools/build.ps1` (bumpea `config/version` y exporta). | Aceptada |
